    ...
    for iteration, batch in enumerate(data_loader):
        ...
        if split == 'train' and iteration % args.train_eval_freq == 0:
            ...
            print("%s\trecon_loss\t%9.4f\tmask_loss\t%9.4f\txCritic_loss\t%9.4f\tzCritic_loss\t%9.4f\tmCritic_loss\t%9.4f\n\tinput_match_loss\t%9.4f\toutput_match_loss\t%9.4f\tgen_match_loss\t%9.4f\n\tinput_mask_match_loss\t%9.4f\toutput_mask_match_loss\t%9.4f\timi_mask_match_loss\t%9.4f"%(
                    ...
                    input_match_loss/batch_size, output_match_loss/batch_size, gen_match_loss/batch_size, 
                    input_m_match_loss/batch_size, output_m_match_loss/batch_size, gen_m_match_loss/batch_size))
            ...
            print("%s\trecon_loss\t%9.4f\tmask_loss\t%9.4f\txCritic_loss\t%9.4f\tzCritic_loss\t%9.4f\tmCritic_loss\t%9.4f\n\tinput_match_loss\t%9.4f\toutput_match_loss\t%9.4f\tgen_match_loss\t%9.4f\n\tinput_mask_match_loss\t%9.4f\toutput_mask_match_loss\t%9.4f\timi_mask_match_loss\t%9.4f"%(
                    ...
                    input_match_total_loss/n_data, output_match_total_loss/n_data, gen_match_total_loss/n_data, 
                    input_m_match_total_loss/n_data, output_m_match_total_loss/n_data, gen_m_match_total_loss/n_data))
            print()
